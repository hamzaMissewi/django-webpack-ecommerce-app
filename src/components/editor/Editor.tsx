...
//     return (
//         <div
//             className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 text-gray-800 p-4 sm:p-8">
...
//                     <div
//                         className="bg-white/95 backdrop-blur-sm p-6 sm:p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
//                         <div className="mb-6">
//                             <input
//                                 type="file"
//                                 accept=".svg"
...
//                                     <div>
//                                         <label className="block text-sm font-medium mb-2 text-gray-700">Size
//                                             (px)</label>
//                                         <input
//                                             type="number"
//                                             value={controls.size}
...
//                                     </div>
//                                     <div>
//                                         <label className="block text-sm font-medium mb-2 text-gray-700">Fill
//                                             Color</label>
...
//                                     </div>
//                                     <div>
//                                         <label className="block text-sm font-medium mb-2 text-gray-700">Stroke
//                                             Color</label>
//                                         <div className="flex gap-2">
//                                             <input
//                                                 type="color"
...
//                                     </div>
//                                     <div>
//                                         <label className="block text-sm font-medium mb-2 text-gray-700">Rotation
//                                             (deg)</label>
//                                         <input
//                                             type="number"
...
//                                     </div>
//                                     <div>
//                                         <label className="block text-sm font-medium mb-2 text-gray-700">Animation
//                                             Speed</label>
//                                         <input
//                                             type="number"
...
//                                     {/*// className="w-full overflow-auto flex items-center justify-center bg-[url('/grid.png')] rounded-lg"*/}
//                                     <div
//                                         className="w-full overflow-auto flex items-center justify-center rounded-lg"
...
//                                         <div
//                                             className="bg-white rounded-xl p-6 w-full max-w-4xl max-h-[85vh] overflow-auto">
//                                             <div className="flex justify-between items-center mb-4">
//                                                 <h3 className="text-xl font-semibold text-gray-800">React Component
//                                                     Code</h3>
//                                                 <button
...
//                         ) : (
//                             <div
//                                 className="h-[calc(100vh-250px)] flex flex-col items-center justify-center text-gray-500 space-y-4">
...
//             {showCopiedIndicator && (
//                 <div
//                     className="fixed bottom-8 right-8 bg-gradient-to-r from-green-500 to-emerald-500 text-white px-5 py-2.5 rounded-lg shadow-lg animate-fade-in-out flex items-center gap-2">
//                     <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
